...
Rtree.egg-info/requires.txt
Rtree.egg-info/top_level.txt
docs/Makefile
docs/source/._README.txt
docs/source/._changes.txt
docs/source/._index.txt
docs/source/._tutorial.txt
docs/source/README.txt
...
tests/.___init__.py
tests/._index.txt
tests/._properties.txt
tests/._test_doctests.py
tests/BoundsCheck.txt
tests/Clobber.txt
tests/__init__.py
tests/__init__.pyc
tests/benchmarks.py
tests/boxes_15x15.data
tests/boxes_3x3.data
tests/data.py
tests/data.pyc
tests/index.txt
tests/point_clusters.data
